...
class TextManager:
    ...
    def set_texts(self):
        self.texts[TextName.Prologue_01_01] = TextInfo(20, 54, 8 * 0)  # ペンギンさんと
        self.texts[TextName.Prologue_01_02] = TextInfo(20, 66, 8 * 1)  # おでかけに行く
        self.texts[TextName.Prologue_01_03] = TextInfo(20, 78, 8 * 2)  # 約束をしていた
        self.texts[TextName.Prologue_01_04] = TextInfo(24, 90, 8 * 3)  # しろくまさん

        self.texts[TextName.Prologue_02_01] = TextInfo(
            10, 66, 8 * 4
        )  # あ！ペンギンさんだ！
        self.texts[TextName.Prologue_02_02] = TextInfo(34, 78, 8 * 5)  # おーい！

        self.texts[TextName.Prologue_03_01] = TextInfo(24, 54, 8 * 6)  # わー、今日は
        self.texts[TextName.Prologue_03_02] = TextInfo(24, 66, 8 * 7)  # 楽しみだなぁ
        self.texts[TextName.Prologue_03_03] = TextInfo(36, 90, 8 * 8)  # …ん？
        ...
        self.texts[TextName.Prologue_06_03] = TextInfo(21, 84, 8 * 16)  # アレを抜こう！

        self.texts[TextName.Prologue_07_01] = TextInfo(22, 60, 8 * 17)  # タイミングよく
        self.texts[TextName.Prologue_07_02] = TextInfo(22, 72, 8 * 18)  # クリックすると
        self.texts[TextName.Prologue_07_03] = TextInfo(29, 84, 8 * 19)  # 抜けるよ！
